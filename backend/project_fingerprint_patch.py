"""Deterministic project fingerprints and recruiter reasoning hooks.

Unique technical fingerprints are answered directly from the synchronized
profile. Broader recruiter evidence-comparison questions are delegated to the
shared recruiter_reasoning planner so this wrapper stays small and maintainable.
"""
...
def _fingerprint(resolver, question: str):
